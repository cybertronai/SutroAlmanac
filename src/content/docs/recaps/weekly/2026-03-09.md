...
- [cybertronai/SutroYaro](https://github.com/cybertronai/SutroYaro), the repo, moved from the personal org this week.
- [Survey page](https://cybertronai.github.io/SutroYaro/research/survey/), the 33-experiment survey.
- [GF2 writeup](https://github.com/cybertronai/sutro?tab=readme-ov-file#sgd-vs-gf2-gaussian-elimination-2026-03-09), Yaroslav's SGD versus GF2 evals.
- [Andrew Ng X-rays the AI hype](https://spectrum.ieee.org/andrew-ng-xrays-the-ai-hype), the proxy-overfitting caution.
- [exp_tiled_w1](https://0bserver07.github.io/SutroYaro/findings/exp_tiled_w1/), Andy's tiling experiment.
- [Modal sandboxes](https://modal.com/docs/guide/sandboxes), GPU sandboxes under a budget.
- [exp_sgd_speed](https://cybertronai.github.io/SutroYaro/findings/exp_sgd_speed/), the Sign SGD findings.
- [arXiv:2510.04930](https://arxiv.org/abs/2510.04930), Egalitarian Gradient Descent.
- Telegram archive, week of March 9, 2026, paraphrased rather than quoted.
